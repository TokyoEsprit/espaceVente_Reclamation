...
im.setFitWidth(100);
    ...
    private void Ajouter(ActionEvent event) {
            ...
            FXMLLoader loader = new FXMLLoader
                        (getClass()
                         .getResource("EspaceParticulier.fxml"));
            try {
                Parent root = loader.load();
                EspaceParticulierController apc = loader.getController();
    ...
    private void Reclamation(ActionEvent event) throws IOException {
     ...
     FXMLLoader loader = new FXMLLoader(getClass().getResource("AjoutReclamation.fxml"));
            Parent root = loader.load();
            AjoutReclamationController scene2Controller = loader.getController();
               
            //Get controller of scene2
            //Pass whatever data you want. You can have multiple method calls here
          
            scene2Controller.setProduit(p.getNom());                             
